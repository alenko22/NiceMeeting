...
class User(UserAdmin):
    list_display = ('id', 'password', 'last_login', 'is_superuser', 'username', 'first_name', 'last_name', 'email', 'is_staff', 'is_active', 'date_joined', 'patronymic', 'date_birth', 'sex', 'educational_level', 'children_quantity', 'bad_habits', 'astral_sign', 'social_status')
